const products = [
  {id:1, name:"Sladká kytice", category:"bouquet", price:690, desc:"Elegantní sladká kytice pro výjimečný okamžik.", badge:"OBLÍBENÉ", image:"https://images.unsplash.com/photo-1582293041079-7814c2f12063?auto=format&fit=crop&w=600&q=80"},
  {id:2, name:"Čokoládová kolekce", category:"chocolate", price:490, desc:"Výběr čokoládových dobrot v elegantním balení.", badge:"NOVINKA", image:"https://images.unsplash.com/photo-1549007994-cb92caebd54b?auto=format&fit=crop&w=600&q=80"},
  {id:3, name:"Dárkový box", category:"box", price:790, desc:"Pečlivě sestavený box plný sladkých překvapení.", badge:"", image:"https://images.unsplash.com/photo-1513201099705-a9746e1e201f?auto=format&fit=crop&w=600&q=80"},
  {id:4, name:"Mini sladký box", category:"box", price:390, desc:"Malý dárek, který udělá velkou radost.", badge:"", image:""}, // Bez obrázku -> použije se záložní art
  {id:5, name:"Luxusní sladký box", category:"box", price:1190, desc:"Prémiový dárkový box pro opravdu speciální příležitost.", badge:"PREMIUM", image:""},
  {id:6, name:"Dárek na míru", category:"personal", price:890, desc:"Personalizovaný sladký dárek vytvořený podle vašeho přání.", badge:"NA MÍRU", image:""}
];
...
function renderProducts(list = products){
  ...
  list.forEach((product, index)=>{
    ...
    const visualHtml = product.image 
      ...
      : `<div class="product-art">FLOREA<small>${product.name}</small></div>`;
...
function openProduct(id){
  ...
  const visualModalHtml = p.image
    ? `<img src="${p.image}" alt="${p.name}" class="modal-img">`
    : `<div class="product-art">FLOREA<small>${p.name}</small></div>`;

  document.getElementById("modalContent").innerHTML = `
    <div class="modal-product">
      <div class="modal-product-image">${visualModalHtml}</div>
      <div>
